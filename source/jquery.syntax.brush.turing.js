...
Syntax.register('turing',function(brush) {
	...
	brush.processes.keyword=brush.processes.builtin=function (element, match) {
		return jQuery('<a>').
			attr('href', "http://compsci.ca/holtsoft/doc/"+element.text()+".html").
